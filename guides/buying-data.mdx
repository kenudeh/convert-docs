...
You can also purchase data on Convert, at relatively lower rates than regular means. Here's how to do get started:

1. **[Log in](https://convert.com.ng/login)** or **[Sign up](https://convert.com.ng/signup)** for a free account
2. Click **Buy Data** in your dashboard
...
4. Enter the volume of data you wish to purchase in the **Data Volume** field. The applicable cost will be updated dynamically
5. Enter the recipient phone number in the **Receipint's Line** field 
...
<Info>
Ensure you have sufficient balance in your wallet before initiating data purchase transactions
</Info>
